...
$_['column_url']	               = 'Website URL';
$_['column_action']                = 'Action';

// Entry
$_['entry_url']                    = 'Website URL:<br /><span class="help">Include the full URL to your store. Make sure to add \'/\' at the end. Example: http://www.yourdomain.com/path/<br /><br />Don\'t use directories to create a new store. You should always point another domain or sub domain to your hosting.</span>';
...
$_['entry_tax_default']            = 'Use Website Tax Address:<br /><span class="help">Use the store address to calculate taxes if no one is logged in. You can choose to use the store address for the customers shipping or payment address.</span>';
...
$_['entry_image_thumb']            = 'Page Image Thumb Size:';
$_['entry_image_popup']            = 'Page Image Popup Size:';
$_['entry_image_product']          = 'Page Image List Size:';
$_['entry_image_additional']       = 'Additional Page Image Size:';
$_['entry_image_related']          = 'Related Page Image Size:';
...
$_['error_url']                    = 'Website URL required!';
...
$_['error_image_thumb']            = 'Page Image Thumb Size dimensions required!';
$_['error_image_popup']            = 'Page Image Popup Size dimensions required!';
$_['error_image_product']          = 'Page List Size dimensions required!';
$_['error_image_category']         = 'Category List Size dimensions required!';
$_['error_image_additional']       = 'Additional Page Image Size dimensions required!';
$_['error_image_related']          = 'Related Page Image Size dimensions required!';
...
$_['error_store']                  = 'Warning: This Website cannot be deleted as it is currently assigned to %s orders!';
?>