                    ...
                    <div class="zbox zbox-zindex">
                        ...
                        <div class="inside">
                            <label for="input-parent">
                                 <span><?php echo $text_category_help; ?></span>
                                    <input type="text" name="path" value="" placeholder="<?php echo $text_categories; ?>" id="input-parent"  />
                            ...
                            <p class="button-controls category-childs">
                                <label for="category-childs2">
                                    <input type="checkbox" id="category-childs2"  checked name="js-show_subcategories-2"/> <?php echo $text_show_subcategories; ?>
                                </label>
                            </p>
                            <p class="button-controls">
                                <span class="add-to-menu">
