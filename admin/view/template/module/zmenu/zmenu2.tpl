    ...
    <div class="page-header">
        <div class="container-fluid">
          <div class="pull-right">
              ...
              <a onclick="$('[name=stay]').val(1); $('#form').submit();" class="btn btn-default" data-toggle="tooltip" title="<?php echo $button_save_and_stay; ?>"><i class="fa fa-save"></i> <?php echo $button_save_and_stay; ?></a>
      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
        <table id="module" class="table table-bordered table-hover">
          ...
          <?php if(count($items)) { ?>
              ...
              <tbody id="module-row<?php echo $module_row; ?>">
                <tr>
                  ...
                  <td class="left"><a onclick="$('#module-row<?php echo $module_row; ?>').remove();" class="btn btn-default"><?php echo $button_remove; ?></a></td>
                </tr>
              </tbody>
              <?php $module_row++; ?>
              <?php } ?>
          ...
          <tfoot>
            <tr>
              <td colspan="7"></td>
              <td class="left"><a onclick="addModule();" class="btn btn-default"><i class="fa fa-plus"></i> <?php echo $button_add_module; ?></a></td>
            </tr>
          </tfoot>
            <?php } ?>
        </table>
...
function addModule() {	
	...
	html += '    <td class="left"><a onclick="$(\'#module-row' + module_row + '\').remove();" class="btn btn-default"><?php echo $button_remove; ?></a></td>';
	html += '  </tr>';
	html += '</tbody>';
