...
class ControllerSellerAccountDashboard extends ControllerSellerAccount {
	public function index() {
		...
		$this->data['seller'] = array_merge(
			...
			array('description' => utf8_substr(strip_tags(html_entity_decode($seller['ms.description'], ENT_QUOTES, 'UTF-8')), 0, 200) . '..'),
		...
		$this->data['link_account_profile'] = $this->url->link('seller/account-dashboard', '', 'SSL');
		$this->data['link_clips'] = $this->url->link('account/wishlist', '', 'SSL');
