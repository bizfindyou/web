...
class ControllerCommonHeader extends Controller {
	...
	protected function index() {
		...
		$this->data['text_logged'] = sprintf($this->language->get('text_logged'), $this->url->link('seller/account-dashboard', '', 'SSL'), $this->customer->getFirstName(), $this->url->link('account/logout', '', 'SSL'));
		...
		$this->data['account'] = $this->url->link('seller/account-dashboard', '', 'SSL');
