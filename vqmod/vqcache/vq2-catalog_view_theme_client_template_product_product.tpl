...
<!-- Product Column Left Begin -->
<div class="col-sm-7 col-xs-12">
    <!-- Product Gallery Begin -->
    <a href="image/data/product-img.jpg" class="fancybox" rel="ligthbox"><img src="image/data/product-img.jpg" class="img-full-width" /></a>
        <!-- Gallery Thumbs Begin -->
        <a href="image/data/product-thumb-01.jpg" class="col-xs-3 fancybox gallery-thumbs" rel="ligthbox"><img src="image/data/product-thumb-01.jpg" class="img-full-width" /></a>
        <a href="image/data/product-thumb-02.jpg" class="col-xs-3 fancybox gallery-thumbs" rel="ligthbox"><img src="image/data/product-thumb-02.jpg" class="img-full-width" /></a>
        <a href="image/data/product-thumb-03.jpg" class="col-xs-3 fancybox gallery-thumbs" rel="ligthbox"><img src="image/data/product-thumb-03.jpg" class="img-full-width" /></a>
        <a href="image/data/product-thumb-03.jpg" class="col-xs-3 fancybox gallery-thumbs" rel="ligthbox"><img src="image/data/product-thumb-03.jpg" class="img-full-width" /></a>
        <!-- Gallery Thumbs End -->
    <!-- Product Gallery End -->
</div>
...
<!-- Product Column Right Begin -->
<div class="col-sm-5 col-xs-12" id="product-description-wrapper">
    <h3><img src="<?php echo $seller['thumb']; ?>" /> <?php echo $heading_title; ?> <a href="<?php echo $seller['href']; ?>" class="small">by <?php echo $seller['nickname']; ?></a></h3>
    
    <h4 id="product-name"><b>Description</b></h4>
    <h5 id="product-id">Item ID: <?php echo $model; ?></h5>
        <?php if ($reward) { ?>
        <h5><?php echo $text_reward; ?></h5> <?php echo $reward; ?><br />
        <?php } ?>
  ...
  <?php } ?>
    ...
    <div id="product-ratings">
        ...
        <?php if ($review_status) { ?>
      <div class="review">
        <div><img src="catalog/view/theme/default/image/stars-<?php echo $rating; ?>.png" alt="<?php echo $reviews; ?>" /><br /><br /><a onclick="$('a[href=\'#tab-review\']').trigger('click');"><?php echo $reviews; ?></a>&nbsp;&nbsp;|&nbsp;&nbsp;<a onclick="$('a[href=\'#tab-review\']').trigger('click');"><?php echo $text_write; ?></a></div>
      </div>
      <?php } ?>
    </div>
    <div id="product-hashtag">
    ...
    <div class="col-xs-12 no-pad-lr col-pad-10-20">
        <a onclick="addToWishList('<?php echo $product_id; ?>');" style="cursor:pointer" class="btn-pink text-center text-white"><img src="image/data/btn-paper-clip-pink.jpg" />Add to my clip</a><br />
        <a href="<?php echo $seller['href']; ?>" class="btn-merchant">MORE FROM THIS MERCHANT</a>
        
    </div>
    
    <div class="col-xs-12 no-pad-lr col-pad-10-20" id="product-share">
        <a href="#"><img src="image/data/btn-share-fb.jpg" /></a>
        <a href="#"><img src="image/data/btn-share-twitter.jpg" /></a>
    </div>
</div>
<!-- Product Column Right Begin -->
</div>
